...
def test_median_odd_length():
    """Test median of a list with odd number of elements."""
    assert find_median([1, 3, 5]) == 3
    assert find_median([1, 2, 3, 4, 5]) == 3

def test_median_even_length():
    """Test median of a list with even number of elements."""
    assert find_median([1, 2, 3, 4]) == 2.5
    assert find_median([2, 4, 6, 8]) == 5

def test_median_single_element():
    """Test median of a list with a single element."""
...
def test_median_already_sorted():
    """Test median with a pre-sorted list."""
    assert find_median([1, 2, 3, 4, 5]) == 3

def test_median_unsorted():
    """Test median with an unsorted list."""
    assert find_median([5, 2, 1, 4, 3]) == 3
...
def test_non_list_input_raises_error():
    """Verify that non-list input raises a TypeError."""
...
def test_non_numeric_list_raises_error():
    """Verify that a list with non-numeric elements raises a TypeError."""
